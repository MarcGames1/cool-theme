...
const paths = {
    ...
    package:{
    src: ['**/*','!.vscode', '!node_modules{,/**}','!packaged{,/**' ,'!.gitignore','!gulpfile.babel.js', '!package.json', '!package-lock.json' ],
        dest: 'packaged'
    }
}
...
export const serve = (done)=>{
    server.init({
        proxy:'http://localhost/curs-udemy/'
    })
    done()
}
...
export const compress = () => {
    return gulp.src(paths.package.src)
        .pipe(replace('_themename_', info.name))
